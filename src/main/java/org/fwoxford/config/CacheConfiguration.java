...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("GwBbisStrangerPortal");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("GwBbisStrangerPortal");
        ...
        config.getMapConfigs().put("org.fwoxford.domain.*", initializeDomainMapConfig(jHipsterProperties));
